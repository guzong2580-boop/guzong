...
const practicePeriods = [
  ...
  // [9/9개강 실습 cohort] 출석수업 3회 (대상: 본원 과목 수강자 / 명단 미발표 → 확정 시 attendees 채우면 칩 표시됨)
  { start:"2026-09-12", end:"2026-09-12", label:"사회복지현장실습 오리엔테이션 (9/9개강)", type:"practice", attendees:[] },
  { start:"2026-10-31", end:"2026-10-31", label:"사회복지현장실습 중간평가회 (9/9개강)", type:"practice", attendees:[] },
  { start:"2026-12-19", end:"2026-12-19", label:"사회복지현장실습 최종평가회 (9/9개강)", type:"practice", attendees:[] },
...
const initialNotices = [
  { id:15, tag:"important", title:"📄 9월 9일 개강 학사일정 안내 (26년 2학기)", date:"2026-06-29", content:"2026년 9월 9일 개강 학사일정이 등록되었습니다. (2학기)\n\n▶ 학습기간: 2026-09-09 ~ 2026-12-22\n\n▶ 주요 일정\n• 중간고사: 2026-10-30 ~ 11-03\n• 기말고사: 2026-12-18 ~ 12-22\n\n▶ 사회복지현장실습 / 대면교과목 출석수업 (3회 참석, 본 교육원 과목 수강자만 해당)\n• 오리엔테이션: 2026-09-12(토)\n• 중간평가회: 2026-10-31(토)\n• 최종평가회: 2026-12-19(토)\n\n※ 수강 인원 20명 미만 시 폐강\n위 일정은 교육원 사정에 의해 변경될 수 있습니다.", isNew:true },
